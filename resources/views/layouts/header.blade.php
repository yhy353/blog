                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu text-center" role="menu">
                            <li><a href="{{ url('user', ['name' => Auth::user()->name]) }}"><i class="ion-person"></i>Personal Center</a></li>
                            <li><a href="{{ url('setting') }}"><i class="ion-gear-b"></i>Settings</a></li>
                            @if(Auth::user()->is_admin)
                                <li><a href="{{ url('dashboard') }}"><i class="ion-ios-speedometer"></i>Dashboard</a></li>
                            @endif
                            <li class="divider"></li>
                            <li>
                                <a href="{{ url('logout') }}"
